...
void loop() {
  ...
  while (destination != 5) {  // Loop until the final destination (5) is reached
    ...
    if (statusCode == 200) {  // If the request was successful
      ...
      if (body.equals("Finished")) {
        ...
        destination = 5;  // Mark the end of the route
      } else {
  ...
  while (true) {}  // End the loop once the traversal is complete
}
